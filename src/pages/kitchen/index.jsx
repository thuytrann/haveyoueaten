...
export default function Index() {
  ...
  return (
    <div ref={container} className='fixed h-screen w-screen overflow-hidden kitchen' style={{transition: 'background .2s ease', backgroundRepeat:'no-repeat', backgroundSize: '100%', background: backgroundImage }}>
